import { ALARM_TYPES, getAlarmTypeId } from '../config/alarms';
import { VEHICLES, getTerIdByVehicle } from '../config/vehicles';

const MASSTRANS_API_BASE = process.env.NEXT_PUBLIC_MASSTRANS_API_BASE || 'http://52.66.177.17:12056/api/v1/basic/alarm';
const MASSTRANS_API_KEY = process.env.MASSTRANS_API_KEY || 'ytU2t%2FveJMrA3lyyuFfttL6rf1DUBjRPZjkeTSTNX3mg0DrdI9PhUJFysOUzfMJjwtSvS7K7y8c1sO0%3D';
...
export class MasstransService {
   ...
   */
  static async getBulkAlarmCounts(
    vehicleNumber: string,
    date: string,
